...
export const metadata: Metadata = {
  ...
  description: "웹 프론트엔드 개발자 윤병현의 개발 블로그",
};
    ...
    >
      <body className="min-h-full flex flex-col bg-background text-foreground">
        <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-6">
          ...
          <footer className="flex items-center justify-between border-t border-neutral-200 py-8 text-sm text-neutral-500 dark:border-neutral-800 dark:text-neutral-400">
            <span>© {new Date().getFullYear()} 윤병현</span>
            <div className="flex items-center gap-4">
              <a
                href="https://github.com/78-artilleryman"
                target="_blank"
                rel="noreferrer"
                aria-label="GitHub"
              ...
              <a
                href="https://www.linkedin.com/in/yunbh/"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
                className="transition-colors hover:text-foreground"
